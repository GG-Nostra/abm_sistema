...
<?php 
    ...
    if(isset($_GET['edit_product'])){
        ...
        $get_p = "select * from productos where product_id='$edit_id'";
        ...
        $get_manufacturer = "select * from desarrolladoras where manufacturer_id='$m_id'";
        ...
        $get_p_cat = "select * from categorias where p_cat_id='$p_cat'";
...
<div class="row"><!-- row Begin -->
    ...
    <div class="col-lg-12"><!-- col-lg-12 Begin -->
           <nav class="navbar navbar-inverse embed-responsive">
                ...
                <p class="navbar-text pull-right"><i class="fa fa-pencil fa-1x"></i>  Editar Producto <?php echo $p_title; ?></p>
            </nav>
           <div class="panel-body"><!-- panel-body Begin -->
               ...
               <form method="post" class="form-horizontal" enctype="multipart/form-data"><!-- form-horizontal Begin -->
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <label class="col-md-3 control-label"> Título de Producto </label> 
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <select name="product_cat" class="form-control"><!-- form-control Begin -->
                              ...
                              <option disabled value="Select Product Category">Seleccionar categoría de producto</option>       
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <select name="cat" class="form-control"><!-- form-control Begin -->
                              ...
                              <option disabled value="Select Category">Seleccionar Plataforma</option>
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <label class="col-md-3 control-label"> Imagen Producto 1 </label> 
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <label class="col-md-3 control-label"> Imagen Producto 2 </label> 
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <label class="col-md-3 control-label"> Imagen Producto 3 </label> 
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <label class="col-md-3 control-label"> Palabra clave producto </label> 
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <label class="col-md-3 control-label"> Descripción de Producto </label> 
