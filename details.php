...
if(isset($_GET['pro_id'])){
    ...
    $get_product = "select * from productos where product_id='$product_id'";
    ...
    $get_p_cat = "select * from categorias where p_cat_id='$p_cat_id'";
           ...
           <div class="col-md-12"><!-- col-md-9 Begin -->
                       ...
                       <div class="box"><!-- box Begin -->
                           ...
                           <form action="details.php?add_cart=<?php echo $product_id; ?>" class="form-horizontal" method="post"><!-- form-horizontal Begin -->
                               <div class="form-group"><!-- form-group Begin -->
                                   <label for="" class="col-md-5 control-label">Cantidad de Copias</label>
                               ...
                               <div class="form-group"><!-- form-group Begin -->
                                   <label class="col-md-5 control-label">Plataforma</label>
                               ...
                               <p class="text-center buttons"><button class="btn btn-primary i fa fa-shopping-cart"> Añadir al Carro</button></p>
               ...
               <div class="box" id="details"><!-- box Begin -->
                   ...
                   <p>
                       ...
                       <ul>
                           <li type="square">Playstation</li>
                           <li type="square">Xbox </li>
                           <li type="square">Pc</li>
                       </ul>  
